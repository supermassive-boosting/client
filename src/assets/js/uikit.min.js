/*! UIkit 3.21.7 | https://www.getuikit.com | (c) 2014 - 2024 YOOtheme | MIT License */ (function (
  we,
  xe
) {
  ...
  function g(t, e, i) {
    ...
    for (const n of T(t))
      tt(i) && (i = i.call(n, g(n, e))), i === null ? Ee(n, e) : n.setAttribute(e, i);
  }
  function It(t, e) {
  ...
  const cr = /([!>+~-])(?=\s+[!>+~-]|\s*$)/g,
    ...
    Vs = ct((t) => {
      ...
      for (let s of t.match(hr))
        (s = s.trim()), e || (e = ['!', '+', '~', '-', '>'].includes(s[0])), i.push(s);
  ...
  function Gs(t, e = document, i) {
    ...
    for (let o of s.selectors) {
      ...
      if (
        ...
        (a &&
          o[0] === '-' &&
          (([r, o] = Ys(o)), (a = a.previousElementSibling), (a = C(a, r) ? a : null), !o && n))
      )
        return a;
      if (a) {
        if (n)
  ...
  function Ki(t) {
    return (
      (t[0] = Qi(t[0])), z(t[1]) && (t[1] = t[1].split(' ')), tt(t[2]) && t.splice(2, 0, !1), t
    );
  }
  function dr(t, e) {
    return (i) => {
  ...
  function en(t) {
    ...
    return (i, s) => {
      if (X(s)) {
        ...
        return (
          (i = W(i)), (s = h(i, t)), (s = s === 'auto' ? i[`offset${e}`] : k(s) || 0), s - le(i, t)
        );
  ...
  function le(t, e, i = 'border-box') {
    return h(t, 'boxSizing') === i
      ? Nt(Wt[e].map(kt), (s) => k(h(t, `padding${s}`)) + k(h(t, `border${s}Width`)))
      : 0;
  }
  function gi(t) {
  ...
  function Y(t, e = 'width', i = window, s = !1) {
    return z(t)
      ? Nt(kr(t), (n) => {
          const o = Ir(n);
          return o
            ? Er(o === 'vh' ? Tr() : o === 'vw' ? pi(Mt(i)) : s ? i[`offset${kt(e)}`] : m(i)[e], n)
            : n;
        })
      : k(t);
  }
    ...
    methods: {
      start() {
        this.stop(),
          this.update(),
          this.timer ||
            (b(this.$el, 'countdownstart'), (this.timer = setInterval(this.update, 1e3)));
      },
      stop() {
        this.timer &&
          (clearInterval(this.timer), b(this.$el, 'countdownstop'), (this.timer = null));
      },
      update() {
  ...
  var En = {
    ...
    update: {
      ...
      write({ rows: t }) {
        for (const e of t)
          for (const i of e)
            j(i, this.margin, t[0] !== e), j(i, this.firstColumn, e[U ? e.length - 1 : 0] === i);
      },
      events: ['resize'],
    },
  };
      ...
      l = a(async () => {
        S(e, $s),
          await Promise.all(
            An(e).map(
              (u, f) =>
                new Promise((d) => setTimeout(() => B.start(u, r, i / 2, 'ease').then(d), f * s))
            )
          ),
          _(e, $s);
      }),
  ...
  function la(t, e, i) {
    return [...t].sort(
      (s, n) => J(s, e).localeCompare(J(n, e), void 0, { numeric: !0 }) * (i === 'asc' || -1)
    );
  }
  function ca(t) {
            ...
            return (
              await Promise.all(
                T(t).map((s) => {
                  ...
                  const o = (
                      tt(i) ? i : i === !1 || !this.hasAnimation ? ha : this.hasTransition ? ua : fa
                    )(s, n, this),
  ...
  var Ss = {
    ...
    events: [
      ...
      },
      {
        ...
        handler(t) {
          t.defaultPrevented ||
            (t.preventDefault(), this.isToggled() === v(st, this) && this.toggle());
        },
      },
      {
        name: 'beforeshow',
    ...
    (t._hasComputed = !0),
      Object.defineProperty(t, e, {
        ...
        get() {
          ...
          if (
            !pt(s, e) &&
            ((s[e] = (i.get || i).call(t, n, o)), i.observe && t._computedObserver)
          ) {
            const r = i.observe.call(t, n);
            t._computedObserver.observe(
              ['~', '+', '-'].includes(r[0]) ? o.parentElement : o.getRootNode(),
              Rn
            );
          }
          return s[e];
  ...
  function Ha({ data: t = {} }, { args: e = [], props: i = {} }) {
    G(t) &&
      (t = t.slice(0, e.length).reduce((s, n, o) => (te(n) ? ft(s, n) : (s[e[o]] = n), s), {}));
      ...
      navItems(t) {
        for (const e of t) {
          ...
          if (mt(i)) {
            ...
            this.list && (this.list.id || (this.list.id = Yt(this, this.list)), (o = this.list.id)),
              (n = this.t(i));
        ...
        },
        {
          ...
          async handler(t, e) {
            ...
            if (s === 'image' || i.match(/\.(avif|jpe?g|jfif|a?png|gif|svg|webp)($|\?)/i)) {
              ...
              this.setItem(
                e,
                Ye('iframe', { src: i, allowfullscreen: '', class: 'uk-lightbox-iframe', ...r })
              );
            else if (
              (a = i.match(
    ...
    created() {
      const t = `${this.clsContainer}-${this.pos}`,
        ...
        i =
          ...
          q(this.container, `<div class="${this.clsContainer} ${t}" ${e}></div>`);
      this.$mount(
        q(
          i,
      ...
      t === 'x' || t === 'y'
        ...
        : t === 'scale' &&
          ...
          (n = (o) => {
            ...
            return Oi([o])
              ? Y(o, 'width', e, !0) /
                  e[`offset${(r = o.endsWith) != null && r.call(o, 'vh') ? 'Height' : 'Width'}`]
              : k(o);
          })),
    ...
    return {
      ...
      show(u, f = 0, d) {
        ...
        return (
          ...
          t &&
            Ut(this.getItemIn(!0), 'itemout', { percent: 1 - f, duration: u, timing: p, dir: i }),
    ...
    update: {
      write() {
        for (const t of this.navItems) {
          ...
          e !== !1 &&
            (t.hidden = !this.maxIndex || e > this.maxIndex || (this.sets && !v(this.sets, e)));
        }
  ...
  var Mo = {
    ...
    beforeConnect() {
      this.autoplay === 'inview' && !It(this.$el, 'preload') && (this.$el.preload = 'none'),
        ...
        this.autoplay === 'hover' &&
          (H(this.$el, 'video') ? (this.$el.tabindex = 0) : (this.autoplay = !0)),
  ...
  var Xl = {
      ...
      computed: {
        ...
        target({ target: t }, e) {
          return (
            t && ((t === !0 && D(this.input) === e && this.input.nextElementSibling) || y(t, e))
          );
        },
      },
      update() {
        ...
        },
        {
          read(t) {
            ...
            if (
              ...
              !(i || s || n) ||
                Lo(e) ||
                e[0].some((w, I) => e.some((P) => P[I] && P[I].offsetWidth !== w.offsetWidth)))
            )
    ...
    jo = {
      ...
      connected() {
        this.svg = this.getSvg().then((t) => {
          ...
          return (
            this.svgEl && e !== this.svgEl && ot(this.svgEl), Ic.call(this, e, t), (this.svgEl = e)
          );
        }, A);
      },
      disconnected() {
  ...
  function jc(t) {
    return (
      (t = Wc[t] || t),
      Ni[t] ? (zi[t] || (zi[t] = Vo(Ni[Rc(t)] || Ni[t])), zi[t].cloneNode(!0)) : null
    );
  }
  function Rc(t) {
  ...
  var ih = {
    ...
    watch: {
      items() {
        ...
        for (const i of e) {
          const s = t
            ? N('.uk-navbar-nav > li > a, .uk-navbar-item, .uk-navbar-toggle', i).length
            : '';
          h(i, 'flexGrow', s);
        }
      },
    ...
    ph = {
      ...
      observe: [
        ...
        ut({
          ...
          handler(t) {
            this.$emit(
              this._data.resized && t.some(({ target: e }) => e === Fi(this.$el))
                ? 'update'
                : 'resize'
            ),
      ...
      update: [
        {
          read({ height: t, width: e, margin: i, sticky: s }, n) {
            if (
              ((this.inactive = !this.matchMedia || !R(this.$el) || !this.$el.offsetHeight),
              this.inactive)
            )
              return;
          ...
          write(t, e) {
            ...
            if (
              ...
              if (
                ...
                r < c ||
                (this.showOnUp &&
                  (r <= c || (n === 'down' && i) || (n === 'up' && !this.isFixed && !u)))
              ) {
                if (!this.isFixed) {
      ...
      methods: {
        ...
        show(t) {
          ...
          this.children.forEach((r, a) => {
            j(r, this.cls, n === a),
              g(this.toggles[a], { 'aria-selected': n === a, tabindex: n === a ? null : -1 });
          });
          const o = i >= 0 && i !== s;
