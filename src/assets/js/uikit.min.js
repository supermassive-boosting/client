/*! UIkit 3.21.7 | https://www.getuikit.com | (c) 2014 - 2024 YOOtheme | MIT License */ (function (we, xe) {
  typeof exports == 'object' && typeof module < 'u'
    ? (module.exports = xe())
    : typeof define == 'function' && define.amd
      ? define('uikit', xe)
      : ((we = typeof globalThis < 'u' ? globalThis : we || self), (we.UIkit = xe()));
})(this, function () {
  'use strict';
  ...
  function Ie(t, e) {
    return (
      t === e || (St(t) && St(e) && Object.keys(t).length === Object.keys(e).length && ie(t, (i, s) => i === e[s]))
    );
  }
  function ji(t, e, i) {
  ...
  function nt(t, e, i = 0, s = !1) {
    ...
    const { length: n } = e;
    return n
      ? ((t = mt(t) ? xt(t) : t === 'next' ? i + 1 : t === 'previous' ? i - 1 : t === 'last' ? n - 1 : e.indexOf(W(t))),
  ...
  function g(t, e, i) {
    ...
    for (const n of T(t)) tt(i) && (i = i.call(n, g(n, e))), i === null ? Ee(n, e) : n.setAttribute(e, i);
  }
  function It(t, e) {
  ...
  function re(t) {
    return (t = W(t)), t && ['origin', 'pathname', 'search'].every(e => t[e] === location[e]);
  }
  function Yi(t) {
    if (re(t)) {
  ...
  const cr = /([!>+~-])(?=\s+[!>+~-]|\s*$)/g,
    ...
    Vs = ct(t => {
      ...
      let e = !1;
      const i = [];
      for (let s of t.match(hr)) (s = s.trim()), e || (e = ['!', '+', '~', '-', '>'].includes(s[0])), i.push(s);
  ...
  function Gs(t, e = document, i) {
    ...
    for (let o of s.selectors) {
      let r,
        a = e;
      if (
        (o[0] === '!' && (([r, o] = Ys(o)), (a = e.parentElement.closest(r)), !o && n)) ||
        (a && o[0] === '-' && (([r, o] = Ys(o)), (a = a.previousElementSibling), (a = C(a, r) ? a : null), !o && n))
      )
        return a;
      if (a) {
        if (n)
          return (
            o[0] === '~' || o[0] === '+'
              ? ((o = `:scope > :nth-child(${$t(a) + 1}) ${o}`), (a = a.parentElement))
              : o[0] === '>' && (o = `:scope ${o}`),
            Xi(a, i, o)
          );
        t += `${t ? ',' : ''}${fr(a)} ${o}`;
  ...
  function $(...t) {
    ...
    n.length > 1 && (n = pr(n)), o != null && o.self && (n = gr(n)), s && (n = dr(s, n));
  ...
  function Ki(t) {
    return (t[0] = Qi(t[0])), z(t[1]) && (t[1] = t[1].split(' ')), tt(t[2]) && t.splice(2, 0, !1), t;
  }
  function dr(t, e) {
    return i => {
      const s =
    ...
    return Promise.all(
      T(t).map(
        o =>
          new Promise((r, a) => {
            x(o, De) && b(o, ci);
            const l = [e, De, `${De}-${n ? 'leave' : 'enter'}`, s && `uk-transform-origin-${s}`, n && `${De}-reverse`],
              c = setTimeout(() => b(o, Js), i);
            F(
              o,
              [Js, ci],
              ({ type: u }) => {
                clearTimeout(c), u === ci ? a() : r(o), h(o, 'animationDuration', ''), _(o, l);
              },
              { self: !0 },
            ),
  ...
  function _t(t, e) {
    if (ke(t)) for (e(t), t = t.firstElementChild; t; ) _t(t, e), (t = t.nextElementSibling);
  }
  function y(t, e) {
  ...
  function m(t) {
    const e = ke(t) ? W(t).getBoundingClientRect() : { height: et(t), width: pi(t), top: 0, left: 0 };
    return {
      height: e.height,
      width: e.width,
      top: e.top,
  ...
  function ss(t) {
    ...
    if (ke(r)) {
      const a = E(r);
      (e -= a.top + k(h(r, 'borderTopWidth'))), (i -= a.left + k(h(r, 'borderLeftWidth')));
    }
  ...
  function en(t) {
    ...
    return (i, s) => {
      if (X(s)) {
        ...
        return (i = W(i)), (s = h(i, t)), (s = s === 'auto' ? i[`offset${e}`] : k(s) || 0), s - le(i, t);
  ...
  function Tr() {
    return (
      Ne ||
      (ce || ((ce = y('<div>')), h(ce, { height: '100vh', position: 'fixed' }), $(window, 'resize', () => (Ne = null))),
      q(document.body, ce),
      (Ne = ce.clientHeight),
      ot(ce),
      Ne)
  ...
  function ls(t) {
    xi(t) && cs(t, { func: 'playVideo', method: 'play' }), wi(t) && t.play().catch(A);
  }
  function bi(t) {
    xi(t) && cs(t, { func: 'pauseVideo', method: 'pause' }), wi(t) && t.pause();
  }
  function cn(t) {
    xi(t) && cs(t, { func: 'mute', method: 'setVolume', value: 0 }), wi(t) && (t.muted = !0);
  }
  function hn(t) {
    return wi(t) || xi(t);
  }
      ...
      return new Promise(u => {
        ...
        (function ve() {
          ...
          i[0] === r && f + a < c && (bt = E(l).top + (w ? 0 : r.scrollTop) - I - m(us(l)).height),
            ...
            be === 1 && (P === bt || !vt--) ? u() : ((P = bt), requestAnimationFrame(ve));
        })();
      });
    }
    function n(r) {
  ...
  function Nr(t, e, i, s, n) {
    ...
    return i && ((o[at[n][2]] += i), (o[at[n][3]] -= i)), s && (o = $n(o, E(G(s) ? s[n] : s))), o;
  }
  function zr(t, e, i, s) {
    const [n, o, r, a] = at[s],
      [l] = xn(t, e),
  ...
  var Rr = {
    ...
    connected() {
      g(this.$el, 'role', this.role), (this.date = k(Date.parse(this.$props.date))), (this.end = !1), this.start();
    },
    disconnected() {
      this.stop();
    },
    ...
    methods: {
      start() {
        this.stop(),
          this.update(),
          this.timer || (b(this.$el, 'countdownstart'), (this.timer = setInterval(this.update, 1e3)));
      },
      stop() {
        this.timer && (clearInterval(this.timer), b(this.$el, 'countdownstop'), (this.timer = null));
      },
      update() {
        const t = qr(this.date);
        t.total || (this.stop(), this.end || (b(this.$el, 'countdownend'), (this.end = !0)));
        for (const e of jr) {
  ...
  function Fe(t, e, i) {
    const s = {};
    if ((tt(e) && (e = e.options), e.extends && (t = Fe(t, e.extends, i)), e.mixins))
  ...
  function Le(t) {
    return We((e, i) => ({ disconnect: $(Zr(e), 'scroll', i, { passive: !0 }) }), t, 'scroll');
  }
  function In(t) {
    return {
      observe(e, i) {
        return { observe: A, unobserve: A, disconnect: $(e, ht, i, { passive: !0 }) };
      },
      handler(e) {
        if (!dt(e)) return;
        const i = yt(e),
  ...
  function ws(t, e = !1) {
    ...
    return e && ([i, s] = Be(t)), { top: i, left: s, bottom: i + n, right: s + o };
  }
  async function ta(t, e, i) {
    ...
    s.forEach((p, w) => u[w] && h(p, u[w])), h(e, o), b(e, 'scroll'), await xs();
    const d = s.map((p, w) => D(p) === e && B.start(p, c[w], i, 'ease')).concat(B.start(e, l, i, 'ease'));
    try {
      await Promise.all(d),
        s.forEach((p, w) => {
          g(p, f[w]), D(p) === e && h(p, 'display', c[w].opacity === 0 ? 'none' : '');
        }),
        g(e, 'style', a);
    } catch {
      g(s, 'style', ''), ia(e, o);
  ...
  function ea(t, e, i) {
    const s = e.map((o, r) =>
        D(o) && r in i ? (i[r] ? (R(o) ? Cn(o) : { opacity: 0 }) : { opacity: R(o) ? 1 : 0 }) : !1,
      ),
      n = s.map((o, r) => {
  ...
  function Cn(t) {
    ...
    return { height: e, width: i, transform: '', ...ss(t), ...h(t, ['marginTop', 'marginLeft']) };
  }
  function xs() {
  ...
  function Pn(t, e, i, s = 0) {
    const n = Ii(e, !0),
      ...
      l = a(async () => {
        S(e, $s),
          await Promise.all(
            An(e).map((u, f) => new Promise(d => setTimeout(() => B.start(u, r, i / 2, 'ease').then(d), f * s))),
          ),
          _(e, $s);
      }),
      c = a(async () => {
        ...
        u !== d && w.push(B.start(e, { height: d }, i / 2 + p.length * s, 'ease')),
          await Promise.all(w).then(() => {
            _(e, ys),
              n === Ii(e) &&
                (h(e, { height: '', alignContent: '' }), h(f, { opacity: '' }), delete e.dataset.transition);
          });
      });
    return x(e, $s) ? _n(e).then(c) : x(e, ys) ? _n(e).then(l).then(c) : l().then(c);
  }
  function Ii(t, e) {
    return e && (t.dataset.transition = 1 + Ii(t)), xt(t.dataset.transition) || 0;
  }
  function _n(t) {
    return Promise.all(
      M(t)
        .filter(B.inProgress)
        .map(e => new Promise(i => F(e, 'transitionend transitioncanceled', i))),
    );
  }
  function An(t) {
  ...
  var On = {
    ...
    methods: {
      animate(t, e = this.$el) {
        ...
        return (
          i === 'fade' ? Pn : i === 'delayed-fade' ? (...n) => Pn(...n, 40) : i ? ta : () => (t(), Promise.resolve())
    ...
    methods: {
      ...
      getState() {
        return this.toggles
          ...
          .reduce((t, e) => Mn(e, this.attrItem, t), { filter: { '': '' }, sort: [] });
      },
      async setState(t, e = !0) {
        (t = { filter: { '': '' }, sort: [], ...t }), b(this.$el, 'beforeFilter', [this, t]);
      ...
      (s || X(o)) &&
        (n
          ? s
            ...
            : (delete i.filter[n], (ti(i.filter) || '' in i.filter) && (i.filter = { '': s || '' }))
          : (i.filter = { '': s || '' })),
      X(o) || (i.sort = [o, r]),
      i
    );
  ...
  function la(t, e, i) {
    return [...t].sort((s, n) => J(s, e).localeCompare(J(n, e), void 0, { numeric: !0 }) * (i === 'asc' || -1));
  }
  function ca(t) {
  ...
  function Bn(t) {
    ...
    return (
      ...
      () => {
        (ks = !1), e(), h(i, { overflowY: '', touchAction: '', paddingRight: '' });
      }
    );
  }
  var je = {
    ...
    qt = {
      ...
      methods: {
            ...
            return (
              await Promise.all(
                T(t).map(s => {
                  ...
                  if (!b(s, `before${n ? 'show' : 'hide'}`, [this])) return Promise.reject();
                  const o = (tt(i) ? i : i === !1 || !this.hasAnimation ? ha : this.hasTransition ? ua : fa)(
                      s,
                      n,
                      this,
                    ),
        ...
        _toggle(t, e) {
          ...
          let i;
          this.cls
            ? ((i = v(this.cls, ' ') || e !== x(t, this.cls)), i && j(t, this.cls, v(this.cls, ' ') ? void 0 : e))
  ...
  async function ua(t, e, { animation: i, duration: s, velocity: n, transition: o, _toggle: r }) {
    ...
    const be = Object.fromEntries(
        ['padding', 'border', 'width', 'height', 'minWidth', 'minHeight', 'overflowY', 'overflowX', I, P].map(sr => [
          sr,
          t.style[sr],
        ]),
      ),
    ...
    d && (h(t, I, Kt - vt + Ws), (ir[I] = e ? Ws : Kt + Ws)),
      !d ^ (l === 'reveal') && (h(Hi, I, -Kt + vt), B.start(Hi, { [I]: e ? 0 : -Kt }, s, o));
    try {
  ...
  function fa(t, e, i) {
    ...
    return e ? (o(t, !0), Ct.in(t, s[0], n, i.origin)) : Ct.out(t, s[1] || s[0], n, i.origin).then(() => o(t, !1));
  }
  const st = [];
  var Ss = {
    mixins: [it, je, qt],
    ...
    connected() {
      g(this.panel || this.$el, 'role', this.role), this.overlay && g(this.panel || this.$el, 'aria-modal', !0);
    },
    beforeDisconnect() {
    ...
    events: [
      ...
      },
      {
        ...
        self: !0,
        handler(t) {
          t.defaultPrevented || (t.preventDefault(), this.isToggled() === v(st, this) && this.toggle());
        },
      },
      {
        name: 'beforeshow',
        ...
        handler(t) {
          ...
          !this.stack && st.length
            ? (Promise.all(st.map(e => e.hide())).then(this.show), t.preventDefault())
            : st.push(this);
        },
      },
      {
      ...
      },
      {
        ...
        self: !0,
        handler() {
          ai(this.$el) || g(this.$el, 'tabindex', '-1'), C(this.$el, ':focus-within') || this.$el.focus();
        },
      },
      {
        name: 'hidden',
    ...
    methods: {
      ...
      show() {
        return this.container && D(this.$el) !== this.container
          ? (q(this.container, this.$el), new Promise(t => requestAnimationFrame(() => this.show().then(t))))
    ...
    return new Promise((n, o) =>
      F(t, 'show hide', () => {
        ...
        const a = F(
            ...
            'transitionstart',
            () => {
              F(i, 'transitionend transitioncancel', n, { self: !0 }), clearTimeout(l);
            },
            { self: !0 },
          ),
          l = setTimeout(
  ...
  var Ei = {
      ...
      methods: {
        t(t, ...e) {
          ...
          let o = 0;
          return (
            ((n = ((i = this.i18n) == null ? void 0 : i[t]) || ((s = this.$options.i18n) == null ? void 0 : s[t])) ==
            null
              ? void 0
              : n.replace(/%s/g, () => e[o++] || '')) || ''
          );
    ...
    ba = {
      ...
      connected() {
        g(this.list, 'aria-live', this.autoplay ? 'off' : 'polite'), this.autoplay && this.startAutoplay();
      },
      disconnected() {
        this.stopAutoplay();
      },
      ...
      methods: {
        startAutoplay() {
          this.stopAutoplay(),
            (this.interval = setInterval(() => {
              this.stack.length ||
                (this.draggable && C(this.$el, ':focus-within') && !C(this.$el, ':focus')) ||
    ...
    methods: {
      ...
      move(t) {
        ...
        let { slides: i, prevIndex: s } = this,
          ...
          r = Wn.call(this, s, o);
        for (; o !== s && n > r; )
          (this.drag -= r * this.dir), (s = o), (n -= r), (o = this.getIndex(s + this.dir)), (r = Wn.call(this, s, o));
        this.percent = n / r;
        const a = i[s],
          l = i[o],
          c = this.index !== o,
        ...
        for (const d of [this.index, this.prevIndex])
          v([o, s], d) || (b(i[d], 'itemhidden', [this]), u && ((f = !0), (this.prevIndex = s)));
        ...
        if ((Tt(document, Es, this.move, qe), Tt(document, Hn, this.end, Fn), this.dragging))
    ...
    (t._hasComputed = !0),
      Object.defineProperty(t, e, {
        ...
        get() {
          ...
          if (!pt(s, e) && ((s[e] = (i.get || i).call(t, n, o)), i.observe && t._computedObserver)) {
  ...
  function Ea(t) {
    var e;
    (e = t._computedObserver) == null || e.disconnect(), delete t._computedObserver, Un(t);
  }
  function Un(t) {
    const e = { ...t._computed };
  ...
  function Vn(t, e, i) {
    ...
    (n = tt(n) ? n.call(t, t) : n || t.$el),
      !(!n || (G(n) && !n.length) || (c && !c.call(t, t))) &&
        t._events.push(
          $(n, s, l ? (z(l) ? l : l.call(t, t)) : null, z(o) ? t[o] : o.bind(t), {
            passive: a,
            capture: r,
            self: u,
          }),
  ...
  function Aa(t, e) {
    ...
    const c = pt(t, l) ? t[l] : s,
      u = i(c, n, o, a);
    tt(s) && G(t[l]) && jn(t, { handler: Oa(u, o), immediate: !1 }, l), Yn(t, u);
  }
  function Oa(t, e) {
    return (i, s) => {
  ...
  function Gn(t) {
    ...
    for (const a in s) {
      const l = Dt(a);
      let c = J(n, l);
      X(c) || ((c = s[a] === Boolean && c === '' ? !0 : ms(s[a], c)), !(l === 'target' && gt(c, '_')) && (e[a] = c));
    }
    const r = he(J(n, o), i);
    for (const a in r) {
      const l = $e(a);
  ...
  function Cs(t) {
    t._connected && (de(t, 'beforeDisconnect'), Ca(t), Jr(t), _a(t), Ea(t), de(t, 'disconnected'), (t._connected = !1));
  }
  let Na = 0;
  function Xn(t, e = {}) {
  ...
  function Ha({ data: t = {} }, { args: e = [], props: i = {} }) {
    G(t) && (t = t.slice(0, e.length).reduce((s, n, o) => (te(n) ? ft(s, n) : (s[e[o]] = n), s), {}));
  ...
  function Ue(t, e, i, ...s) {
    const n = Jn(t);
    return n.options.functional ? new n({ data: te(e) ? e : [e, i, ...s] }) : e ? N(e).map(o)[0] : o();
    function o(r) {
      const a = Ti(r, t);
      if (a)
        if (i) a.$destroy();
  ...
  function Ra(t) {
    (t.component = Jn),
      ...
      (t.mixin = function (i, s) {
        (s = (z(s) ? this.component(s) : s) || this), (s.options = Fe(s.options, i));
      }),
      (t.extend = function (i) {
        i || (i = {});
        const s = this,
      ...
      navItems(t) {
        for (const e of t) {
          ...
          if (mt(i)) {
            const r = xt(i),
              a = this.slides[r];
            a && (a.id || (a.id = Yt(this, a)), (o = a.id)), (n = this.t('slideX', k(i) + 1)), g(s, 'role', 'tab');
          } else
            this.list && (this.list.id || (this.list.id = Yt(this, this.list)), (o = this.list.id)), (n = this.t(i));
        ...
        for (const e of this.navItems) {
          ...
          if (mt(i)) {
            ...
            j(e, this.clsActive, o),
              ...
              g(s, { 'aria-selected': o, tabindex: o && !this.parallax ? null : -1 }),
    ...
    so = {
      ...
      created() {
        ...
        const i = y('[uk-close]', t),
          s = this.t('close');
        i && s && (i.dataset.i18n = JSON.stringify({ label: s })), this.$mount(q(this.container, t));
      },
      events: [
        ...
        { name: 'shown', self: !0, handler: 'showControls' },
        {
          ...
          self: !0,
          handler() {
            this.hideControls(), _(this.slides, this.clsActive), B.stop(this.slides);
          },
        },
        {
          name: 'hidden',
        ...
        },
        {
          ...
          async handler(t, e) {
            ...
            if (s === 'image' || i.match(/\.(avif|jpe?g|jfif|a?png|gif|svg|webp)($|\?)/i)) {
              ...
              $(c, 'load', () => this.setItem(e, c)), $(c, 'error', () => this.setError(e));
              ...
              $(c, 'loadedmetadata', () => this.setItem(e, c)), $(c, 'error', () => this.setError(e));
            } else if (s === 'iframe' || i.match(/\.(html|php)($|\?)/i))
              this.setItem(e, Ye('iframe', { src: i, allowfullscreen: '', class: 'uk-lightbox-iframe', ...r }));
            else if (
  ...
  function Ka(t, e) {
    t.lightboxPanel || t.component('lightboxPanel', so), ft(e.props, t.component('lightboxPanel').options.props);
  }
  function no(t) {
    const e = {};
    for (const i of ['href', 'caption', 'type', 'poster', 'alt', 'attrs']) e[i === 'href' ? 'source' : i] = J(t, i);
  ...
  var Qa = {
    ...
    async connected() {
      ...
      await B.start(h(this.$el, this.startProps), { opacity: 1, [this.marginProp]: t }),
    ...
    methods: {
      async close(t) {
        const e = i => {
          const s = D(i);
          b(i, 'close', [this]), ot(i), (s != null && s.hasChildNodes()) || ot(s);
        };
        this.timer && clearTimeout(this.timer), t || (await B.start(this.$el, this.startProps)), e(this.$el);
      },
    },
  };
  function Za(t) {
  ...
  var Ci = {
    ...
    connected() {
      ...
      if (((this.matchMedia = !0), t)) {
        ...
        const e = () => {
          (this.matchMedia = this.mediaObj.matches), b(this.$el, ae('mediachange', !1, !0, [this.mediaObj]));
        };
  ...
  function _i(t, e, i) {
    ...
    return (
      t === 'x' || t === 'y'
        ? ((t = `translate${kt(t)}`), (n = o => k(k(o).toFixed(s === 'px' ? 0 : 6))))
        : t === 'scale' &&
          ((s = ''),
          (n = o => {
            var r;
            return Oi([o])
              ? Y(o, 'width', e, !0) / e[`offset${(r = o.endsWith) != null && r.call(o, 'vh') ? 'Height' : 'Width'}`]
              : k(o);
          })),
  ...
  function Ps(t, e, i) {
    return (
      ...
      (s, n) => {
        const [o, r, a] = fo(i, n),
          l = o.map((c, u) => ((c += a * (r[u] - c)), u === 3 ? k(c) : parseInt(c, 10))).join(',');
        s[t] = `rgba(${l})`;
      }
    );
  }
  ...
  function nl(t, e, i, s) {
    ...
    for (const u of r) {
      const f = s[u].map(([P]) => P),
        ...
        I = p - d;
      (a[u] = `${(w ? -I : 0) - (w ? d : p)}px`), (o[u === 'bgy' ? 'height' : 'width'] += I);
    }
  ...
  var al = {
    ...
    observe: [vs(), Le({ target: ({ target: t }) => t }), ut({ target: ({ $el: t, target: e }) => [t, e, Ot(e, !0)] })],
    update: {
      read({ percent: t }, e) {
  ...
  var vo = {
    ...
    observe: [
      ut({ target: ({ $el: t, parallaxTarget: e }) => [t, e], filter: ({ parallax: t }) => t }),
    ...
    update: {
      ...
      write({ parallax: t }) {
        ...
        if (~this.prevIndex)
          for (const f of new Set([this.index, this.prevIndex])) v([s, e], f) || (l(this.slides[f]), c(this.slides[f]));
  ...
  function ll(t) {
    ...
    function n(l) {
      x(l, s) && (r(l), a(l)), x(l, e) || (b(l, 'beforeitemshow', [t]), b(l, 'itemshow', [t]));
    }
    function o(l) {
      x(l, i) && b(l, 'itemshown', [t]);
    }
    function r(l) {
      x(l, e) || n(l), x(l, i) && o(l), x(l, s) || (b(l, 'beforeitemhide', [t]), b(l, 'itemhide', [t]));
    }
    function a(l) {
  ...
  var bo = {
    ...
    wo = {
      observe: Si({ target: ({ slides: t }) => t, targets: t => t.getAdjacentSlides() }),
      methods: {
        getAdjacentSlides() {
    ...
    return {
      ...
      show(u, f = 0, d) {
        ...
        return (
          ...
          (f = t ? f : Q(f, 0, 1)),
          Ut(this.getItemIn(), 'itemin', { percent: f, duration: u, timing: p, dir: i }),
          t && Ut(this.getItemIn(!0), 'itemout', { percent: 1 - f, duration: u, timing: p, dir: i }),
          B.start(o, { transform: L(-a * (U ? -1 : 1), 'px') }, u, p).then(c, A),
          l
        );
      },
      cancel() {
  ...
  var ul = {
      ...
      sets({ sets: t }) {
        ...
        for (let n = 0; n < this.length; n++) {
          ...
          e + o > s && (e = 0),
            this.center
              ? e < s / 2 &&
                e + o + m(this.slides[nt(n + 1, this.slides)]).width / 2 > s / 2 &&
                (i.push(n), (e = s / 2 - o / 2))
    ...
    events: {
      beforeitemshow(t) {
        ...
        (this.duration = to(s / this.velocity) * (m(this.slides[i]).width / s)), this.reorder();
      },
      itemshow() {
    ...
    methods: {
      reorder() {
        ...
        if (
          (this.slides.forEach((n, o) =>
            h(n, 'order', this.dir > 0 && o < t ? 1 : this.dir < 0 && o >= this.index ? -1 : ''),
          ),
      ...
      updateActiveClasses(t = this.index) {
        ...
        for (const s of this.slides) {
          ...
          for (const o of N(Ce, s))
            pt(o, '_tabindex') || (o._tabindex = g(o, 'tabindex')), g(o, 'tabindex', n ? o._tabindex : -1);
        }
      },
      getValidIndex(t = this.index, e = this.prevIndex) {
      ...
      getIndexAt(t) {
        let e = -1;
        const i = this.center
          ? me(this.list) - (m(this.slides[0]).width / 2 + m(Bt(this.slides)).width / 2)
  ...
  var pl = {
      ...
      scale: {
        show() {
          return [{ opacity: 0, transform: fe(1 + 0.5), zIndex: 0 }, { zIndex: -1 }];
        },
        percent(t) {
          return 1 - h(t, 'opacity');
        },
        translate(t) {
          return [{ opacity: 1 - t, transform: fe(1 + 0.5 * t), zIndex: 0 }, { zIndex: -1 }];
        },
      },
      pull: {
        show(t) {
    ...
    ml = {
      ...
      watch: {
        ...
        handles(t, e) {
          h(e, { touchAction: '', userSelect: '' }), h(t, { touchAction: 'none', userSelect: 'none' });
        },
      },
      update: {
        write(t) {
          ...
          u !== !1 &&
            ((u && o === u) ||
              (r !== c ? (c.remove(o), (t.moved = l)) : delete t.moved, r.insert(o, u), this.touched.add(r)));
        },
        events: ['move'],
      },
      methods: {
        ...
        start(t) {
          ...
          ft(this.origin, { offsetLeft: this.pos.x - e, offsetTop: this.pos.y - i }),
        ...
        move: kl(function (t) {
          ...
          if ((Tt(document, ni, this.move), Tt(document, Et, this.end), !this.drag)) return;
          bl();
          const t = this.getSortable(this.placeholder);
          this === t
            ? this.origin.index !== $t(this.placeholder) && b(this.$el, 'moved', [this, this.placeholder])
            : (b(t.$el, 'added', [t, this.placeholder]), b(this.$el, 'removed', [this, this.placeholder])),
        ...
        insert(t, e) {
          S(this.items, this.clsItem),
            e && e.previousElementSibling !== t
              ? this.animate(() => hi(e, t))
              : !e && this.target.lastElementChild !== t && this.animate(() => q(this.target, t));
        },
        remove(t) {
  ...
  function $l(t, e, i, s, n, o) {
    ...
    const r = m(e);
    if (!o) return yl(t, i) || n < r.top + r.height / 2 ? e : e.nextElementSibling;
    const a = m(i),
  ...
  var To = {
    props: { pos: String, offset: Boolean, flip: Boolean, shift: Boolean, inset: Boolean },
    data: { pos: `bottom-${U ? 'right' : 'left'}`, offset: !1, flip: !0, shift: !0, inset: !1 },
    connected() {
    ...
    methods: {
      ...
      getShiftOffset(t = this.$el) {
        return this.align === 'center'
          ? 0
          : Y(h(t, '--uk-position-shift-offset'), this.axis === 'y' ? 'width' : 'height', t) *
          ...
          $(this.tooltip, 'toggled', (i, s) => {
            ...
            const a = [
              F(
                ...
                this.hide,
                !1,
                l => (l.type === ht && !this.$el.contains(l.target)) || (l.type === 'keydown' && l.keyCode === O.ESC),
              ),
  ...
  function _o(t) {
    b(document, 'uikit:init', t),
      ...
      new MutationObserver(e => e.forEach(Ml)).observe(document, { subtree: !0, childList: !0 }),
      new MutationObserver(e => e.forEach(Bl)).observe(document, { subtree: !0, attributes: !0 }),
      (t._initialized = !0);
  }
  ...
  var Mo = {
    ...
    observe: [
      ue({
        ...
        args: { intersecting: !1 },
        options: ({ $el: t, autoplay: e }) => ({ root: e === 'inview' ? null : D(t) }),
      }),
    ],
  };
  function Wl(t) {
  ...
  var jl = {
    ...
    observe: ut({ target: ({ $el: t }) => Bo(t) || D(t), filter: ({ useObjectFit: t }) => !t }),
    update: {
      read() {
  ...
  var No = {
    ...
    events: [
      ...
      },
      {
        ...
        self: !0,
        handler() {
          (K = this), this.tracker.init(), g(this.targetEl, 'aria-expanded', !0);
      ...
      { name: 'beforehide', self: !0, handler: 'clearTimers' },
      {
        ...
        handler({ target: t }) {
          ...
          (K = this.isActive() ? null : K), this.tracker.cancel(), g(this.targetEl, 'aria-expanded', null);
        },
      },
    ],
    update: {
    ...
    methods: {
      show(t = this.targetEl, e = !0) {
        if (
          ...
          if (K) {
            ...
            let i;
            for (; K && i !== K && !K.$el.contains(this.$el); ) (i = K), K.hide(!1, !1);
          }
      ...
      isDelaying() {
        return [this.$el, ...N('.uk-drop', this.$el)].some(t => this.tracker.movesTo(t));
      },
      position() {
        const t = Co(this.$el);
        ...
        for (const [o, [r, a, l, c]] of s)
          if (this.axis === r && v([r, !0], this.stretch)) {
            ...
            h(this.$el, {
              [a]:
                (f[l] > d[l]
                  ? f[this.inset ? c : l] - Math.max(E(this.boundary[o])[l], e[o][l] + i)
                  : Math.min(E(this.boundary[o])[c], e[o][c] - i) - f[this.inset ? l : c]) - u,
              [`overflow-${r}`]: 'auto',
            }),
              this.positionAt(this.$el, this.target, this.boundary);
          }
  ...
  function ql(t) {
    const { $el: e } = t.$create('toggle', Z(t.toggle, t.$el), { target: t.$el, mode: t.mode });
  ...
  var Fo = {
    ...
    computed: {
      ...
      dropbar({ dropbar: t }) {
        return t
          ? ((t = this._dropbar || Z(t, this.$el) || y(`+ .${this.clsDropbar}`, this.$el)),
      ...
      },
      {
        ...
        handler({ target: t }) {
          this.isDropbarDrop(t) &&
            (this.dropbar.previousElementSibling !== this.dropbarAnchor && ui(this.dropbarAnchor, this.dropbar),
      ...
      async transitionTo(t, e) {
        ...
        h(e, 'clipPath', `polygon(0 0,100% 0,100% ${s}px,0 ${s}px)`),
          ...
          await Promise.all([
            ...
            B.start(e, { clipPath: `polygon(0 0,100% 0,100% ${t}px,0 ${t}px)` }, this.duration).finally(() =>
              h(e, { clipPath: '', transitionDelay: '' }),
            ),
          ]).catch(A);
      },
      getDropdown(t) {
    ...
    a === O.HOME
      ...
      : a === O.END
        ...
        : a === O.LEFT
          ...
          : a === O.RIGHT
            ? (l = 'next')
            : a === O.TAB && ((s = i.targetEl) == null || s.focus(), (n = i.hide) == null || n.call(i, !1)),
      ~l &&
        (t.preventDefault(), (o = i.hide) == null || o.call(i, !1), e[nt(l, e, e.indexOf(i.targetEl || r))].focus());
  }
  var Xl = {
      mixins: [it],
      args: 'target',
      ...
      update() {
        ...
        const n = ri(e) ? 'value' : 'textContent',
          ...
          r =
            (t = i.files) != null && t[0]
              ? i.files[0].name
              : C(i, 'select') && (s = N('option', i).filter(a => a.selected)[0])
                ? s.textContent
                : i.value;
        o !== r && (e[n] = r);
      },
  ...
  function Kl(t, e, i) {
    ...
    for (let a of t) {
      ...
      for (const c in a) {
        ...
        As(s, d, a[c]), As(n, d, [(d - c) * u * (U ? -1 : 1), o[d] - r]), (o[d] += f + e), (l = Math.max(l, f));
      }
      r += l + e;
    }
    return [s, n];
  ...
  var tc = {
    ...
    update: {
      read() {
        return { rows: (this.row ? bs(this.elements) : [this.elements]).map(ec) };
      },
      write({ rows: t }) {
  ...
  var sc = {
      ...
      props: { target: String },
      data: { target: '' },
      computed: { target: { get: ({ target: t }, e) => Z(t, e), observe: ({ target: t }) => t } },
    ...
    nc = {
      ...
      observe: [vs({ filter: ({ expand: t }) => t }), ut({ target: ({ $el: t }) => jt(t) })],
      update: {
        read() {
            ...
            this.offsetBottom === !0
              ...
              : mt(this.offsetBottom)
                ...
                : this.offsetBottom && Qt(this.offsetBottom, 'px')
                  ...
                  : z(this.offsetBottom) && (t += ` - ${m(Z(this.offsetBottom, this.$el)).height}px`);
          }
    ...
    jo = {
      ...
      connected() {
        this.svg = this.getSvg().then(t => {
          ...
          return this.svgEl && e !== this.svgEl && ot(this.svgEl), Ic.call(this, e, t), (this.svgEl = e);
        }, A);
      },
      disconnected() {
        this.svg.then(t => {
          this._connected || (Vi(this.$el) && (this.$el.hidden = !1), ot(t), (this.svgEl = null));
        }),
          (this.svg = null);
      },
  ...
  function Ic(t, e) {
    ...
    const n = g(e, 'viewBox');
    n && !s.some(o => o) && (s = n.split(' ').slice(2)), s.forEach((o, r) => g(t, i[r], k(o) * this.ratio || null));
  }
  var Ec = {
    mixins: [jo],
    args: 'src',
  ...
  const Tc = ct(async t =>
    t ? (gt(t, 'data:') ? decodeURIComponent(t.split(',')[1]) : (await fetch(t)).text()) : Promise.reject(),
  );
  function Cc(t, e) {
  ...
  const Ni = {
    ...
    Oc = {
      ...
      beforeConnect() {
        const t = x(this.$el, 'uk-search-toggle') || x(this.$el, 'uk-navbar-toggle');
        if (
          ((this.icon = t
            ? 'search-toggle-icon'
            : x(this.$el, 'uk-search-icon') && this.$el.closest('.uk-search-large')
              ? 'search-large'
    ...
    Dc = {
      ...
      methods: {
        async getSvg() {
          ...
          return this.ratio !== 1 && h(y('circle', t), 'strokeWidth', 1 / this.ratio), t;
        },
      },
    },
    Jt = {
    ...
    Hc = { extends: Jt, i18n: { label: 'Previous page' }, data: { role: null } },
    zi = {};
  function Lc(t) {
    t.icon.add = (e, i) => {
      const s = z(e) ? { [e]: i } : e;
  ...
  const Wc = { twitter: 'x' };
  function jc(t) {
    return (t = Wc[t] || t), Ni[t] ? (zi[t] || (zi[t] = Vo(Ni[Rc(t)] || Ni[t])), zi[t].cloneNode(!0)) : null;
  }
  function Rc(t) {
      ...
      }),
      {
        ...
        observe: (t, e) => {
          const i = ze([...T(t), document.documentElement], e),
            s = [
              $(document, 'scroll itemshown itemhidden', e, { passive: !0, capture: !0 }),
              $(document, 'show hide transitionstart', n => (e(), i.observe(n.target))),
              $(document, 'shown hidden transitionend transitioncancel', n => (e(), i.unobserve(n.target))),
            ];
          return {
    ...
    for (const l of [0.25, 0.5, 0.75]) {
      ...
      for (const u of c) {
        if (
          t.contains(u) ||
          !Kc(u) ||
          (u.closest('[class*="-leave"]') && c.some(d => u !== d && C(d, '[class*="-enter"]')))
        )
          continue;
        const f = h(u, '--uk-inverse');
        if (f) {
          if (f === a) return `uk-${f}`;
          a = f;
          break;
  ...
  var Qc = {
      ...
      computed: { fill: ({ fill: t }, e) => t || h(e, '--uk-leader-fill-content') },
      connected() {
      ...
      update: {
        ...
        write({ width: t, fill: e, hide: i }) {
          j(this.wrapper, this.clsHide, i), g(this.wrapper, this.attrFill, new Array(t).join(e));
        },
        events: ['resize'],
      },
    },
    Zc = {
      ...
      events: [
        ...
        },
        {
          ...
          self: !0,
          handler() {
            x(this.panel, 'uk-margin-auto-vertical') ? S(this.$el, 'uk-flex') : h(this.$el, 'display', 'block'),
              et(this.$el);
          },
        },
        {
        ...
        return e(
          ({ i18n: n }) =>
            `<form> <div class="uk-modal-body">${
              ...
              n.cancel
            }</button> <button class="uk-button uk-button-primary" autofocus>${n.ok}</button> </div> </form>`,
          s,
          () => Promise.reject(),
        );
      }),
        ...
        const o = e(
            ({ i18n: l }) =>
              `<form class="uk-form-stacked"> <div class="uk-modal-body"> <label>${
                ...
                l.cancel
              }</button> <button class="uk-button uk-button-primary">${l.ok}</button> </div> </form>`,
            n,
            () => null,
            () => a.value,
          ),
  ...
  var eh = { extends: Do, data: { targets: '> .uk-parent', toggle: '> a', content: '> ul' } };
  ...
  var ih = {
    ...
    watch: {
      items() {
        ...
        for (const i of e) {
          const s = t ? N('.uk-navbar-nav > li > a, .uk-navbar-item, .uk-navbar-toggle', i).length : '';
          h(i, 'flexGrow', s);
        }
      },
    },
    events: [
      ...
      },
      {
        ...
        async handler() {
          await sh(),
            !this.getActive() && this._transparent && (S(this.navbarContainer, Bs), (this._transparent = null));
        },
      },
    ],
    methods: {
  ...
  var nh = {
    ...
    events: [
      ...
      },
      {
        ...
        self: !0,
        handler() {
          _(document.body, this.clsContainerAnimation), h(document.body, 'touch-action', '');
        },
      },
      {
        name: 'hidden',
  ...
  var ah = {
    ...
    lh = {
      props: ['width', 'height'],
      connected() {
        S(this.$el, 'uk-responsive-width'), h(this.$el, 'aspectRatio', `${this.width}/${this.height}`);
      },
    },
    ch = {
      props: { offset: Number },
        ...
        async scrollTo(t) {
          (t = (t && y(t)) || document.body),
            b(this.$el, 'beforescroll', [this, t]) &&
              (await pn(t, { offset: this.offset }), b(this.$el, 'scrolled', [this, t]));
        },
      },
    };
  const Ke = new Set();
  ...
  var fh = {
      ...
      data: () => ({ cls: '', target: !1, hidden: !0, margin: '-1px', repeat: !1, delay: 0 }),
      ...
      disconnected() {
        for (const [t, e] of this.elementData.entries()) _(t, Ns, (e == null ? void 0 : e.cls) || '');
      ...
      observe: ue({
        ...
        handler(t) {
          ...
          for (const { target: i, isIntersecting: s } of t) {
            e.has(i) || e.set(i, { cls: J(i, 'uk-scrollspy-class') || this.cls });
            const n = e.get(i);
      ...
      methods: {
        toggle(t, e) {
          ...
          if (!n) return;
          (s = n.off) == null || s.call(n), h(t, 'opacity', !e && this.hidden ? 0 : ''), j(t, Ns, e), j(t, n.cls);
          let o;
          if ((o = n.cls.match(/\buk-animation-[\w-]+/g))) {
            const r = () => _(t, o);
            e ? (n.off = F(t, 'animationcancel animationend', r, { self: !0 })) : r();
          }
    ...
    dh = {
      props: { cls: String, closest: Boolean, scroll: Boolean, target: String, offset: Number },
      data: {
        cls: 'uk-active',
        closest: !1,
        scroll: !1,
      ...
      update: [
        {
          read() {
            ...
            if (s >= r) a = e - 1;
              ...
              for (let c = 0; c < t.length && !(E(t[c]).top - o.top - l > 0); c++) a = +c;
            }
            return { active: a };
          },
          write({ active: t }) {
    ...
    ph = {
      ...
      connected() {
        (this.start = Ko(this.start || this.top)),
          ...
          (this.placeholder =
            y('+ .uk-sticky-placeholder', this.$el) || y('<div class="uk-sticky-placeholder"></div>')),
          (this.isFixed = !1),
          this.setActive(!1);
      },
      beforeDisconnect() {
      ...
      update: [
        {
          read({ height: t, width: e, margin: i, sticky: s }, n) {
            if (((this.inactive = !this.matchMedia || !R(this.$el) || !this.$el.offsetHeight), this.inactive)) return;
            const o = this.isFixed && n.has('update');
            o && (Hs(this.target), this.hide()),
              this.active || (({ height: t, width: e } = m(this.$el)), (i = h(this.$el, 'margin'))),
              o && this.show();
          ...
          write({ height: t, width: e, margin: i, offset: s, sticky: n }) {
            ...
            h(o, { height: t, width: e, margin: i }),
              (D(o) !== D(this.$el) || n ^ ($t(o) < $t(this.$el))) && ((n ? hi : ui)(this.$el, o), (o.hidden = !0));
          },
          events: ['resize'],
        },
        {
          ...
          write(t, e) {
            ...
            if (
              ...
              if (
                this.inactive ||
                r < c ||
                (this.showOnUp && (r <= c || (n === 'down' && i) || (n === 'up' && !this.isFixed && !u)))
              ) {
                if (!this.isFixed) {
                  Ct.inProgress(this.$el) && l > r && (Ct.cancel(this.$el), this.hide());
                  return;
                }
                if (this.animation && u) {
      ...
      methods: {
        ...
        hide() {
          ...
          this.setActive(!1),
            ...
            e ? h(this.$el, 'top', t) : h(this.$el, { position: '', top: '', width: '', marginTop: '' }),
        ...
        update() {
          ...
          h(this.$el, 'top', r - s), this.setActive(u), j(this.$el, this.clsBelow, c), S(this.$el, this.clsFixed);
        },
        setActive(t) {
          const e = this.active;
          (this.active = t),
            t
              ? (si(this.target, this.clsInactive, this.clsActive), e !== t && b(this.$el, 'active'))
  ...
  var Zo = {
      ...
      computed: {
        connects: { get: ({ connect: t }, e) => Ae(t, e), observe: ({ connect: t }) => t },
        connectChildren() {
      ...
      watch: {
        ...
        connectChildren() {
          ...
          for (const e of this.connects) M(e).forEach((i, s) => j(i, this.cls, s === t));
          this.$emit();
        },
        toggles(t) {
          this.$emit();
      ...
      events: [
        ...
        },
        {
          ...
          delegate: ({ attrItem: t }) => `[${t}],[data-${t}]`,
          handler(t) {
            t.target.closest('a,button') && (t.preventDefault(), this.show(J(t.current, this.attrItem)));
          },
        },
        {
      ...
      update() {
        var t;
        for (const e of this.connects) H(e, 'ul') && g(e, 'role', 'presentation');
      ...
      methods: {
        ...
        show(t) {
          ...
          this.children.forEach((r, a) => {
            j(r, this.cls, n === a), g(this.toggles[a], { 'aria-selected': n === a, tabindex: n === a ? null : -1 });
          });
          const o = i >= 0 && i !== s;
  ...
  var vh = {
      ...
      computed: {
        target: {
          get: ({ target: t }, e) => ((t = Ae(t || e.hash, e)), t.length ? t : [e]),
          observe: ({ target: t }) => t,
        },
      },
      connected() {
          ...
          handler(t) {
            ...
            (this._preventClick ||
              ...
              ((e = t.target.closest('a[href]')) &&
                (!this.isToggled(this.target) || (e.hash && C(this.target, e.hash))))) &&
              t.preventDefault(),
      ...
      methods: {
        async toggle(t) {
          ...
          if (
            (It(this.$el, 'aria-expanded') && g(this.$el, 'aria-expanded', !this.isToggled(this.target)), !this.queued)
          )
  ...
  return ie(bh, (t, e) => lt.component(e, t)), Dl(lt), ie(Ol, (t, e) => lt.component(e, t)), lt;
});
